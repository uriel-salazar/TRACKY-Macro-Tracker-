from calculating_macros.show_text import activity_level
from calculating_macros.wrap_basic import info_and_bmr
from calculating_macros.calculate import TDEE
from calculating_macros.wrap_basic import info_and_bmr,set_macros
